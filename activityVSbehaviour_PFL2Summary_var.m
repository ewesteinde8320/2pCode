function activityVSbehaviour_PFL2Summary_var(summaryArray_all,meno,regions, data)       
    edges_vy = [-200:10:200];
    edges_vf = [-4:1:10];
...
%% Remove idx where the fly isn't moving
    ...
    %%
        ...
        activity_values = var(activity_temp,[],1);
        ...
        trial_vf(trial_count,:) = var(sum_mean{3},[],2);
        trial_vy(trial_count,:) = var(sum_mean{1},[],2);
        trial_angle(trial_count,:) = var(sum_mean{2},[],2);
